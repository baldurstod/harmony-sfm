...
export class DataModel {
	...
	static GetAttributeNameForType(attType: number/*TODO: improve type*/) {
	...
	*/
	...
	static createElement(ref: undefined, pElementType: string, pElementName?: string, fileid?: never, pObjectID?: UniqueId) {
		if (!pObjectID) {
	...
	static createElementNew(pElementType: string, pElementName: string) {
